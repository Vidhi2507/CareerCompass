...
const ManualEntry = () => {
  ...
  const [formData, setFormData] = useState({fullName: "",gradYear: "",education: "",skills: "",interests: []});
            ...
            {step === 1 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <InputField label="Full Name" placeholder="Vidya Sunil Shinde" name="fullName" value={formData.fullName} onChange={handleChange} />
                  <InputField label="Graduation Year" placeholder="2027" name="gradYear" value={formData.gradYear} onChange={handleChange} />
                  <div className="md:col-span-2">
                    <InputField label="Current Education" placeholder="Master of Computer Applications" name="education" value={formData.education} onChange={handleChange} />
                  </div>
                </div>
              </motion.div>
            )}
